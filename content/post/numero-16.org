...
- Le programme des Entrepreneurs d'intérêt général d'Etalab recrute un.e data scientist pour venir prêter main forte sur un projet porté par l’Agence Régionale de Santé Auvergne-Rhône-Alpes, pendant 6 mois de janvier à mi-juillet 2022 ! Retrouvez l'offre ici [[https://eig.etalab.gouv.fr/img/les-entrepreneurs-d-int%c3%a9r%c3%aat-g%c3%a9n%c3%a9ral-recrutent-un.e-data-scientist-pour-le-projet-datarh.pdf][ici]]. Concrètement, la ou le data scientist recruté.e :
•    Deviendra un.e Entrepreneur.euse d'Intérêt Général, et sera intégré.e à la promotion #5 2021-2022,
•    Sera embauché.e sous CDD de 6 mois aux rémunérations du programme,

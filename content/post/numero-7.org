...
-	Du 2 au 30 novembre se tient le Mois de l’innovation publique, organisé par la DITP. Cette édition 2020 valorise les initiatives locales engagées et les solutions développées en réponse à la crise sanitaire, mais aussi celles qui seront mises en œuvre pour accompagner le plan de relance. Retrouvez [[https://www.etalab.gouv.fr/rdv-etalab-mip-2020][tous les rendez-vous d’Etalab au Mois de l’IP]] et le [[programme des événements du Mois de l’IP ][https://www.modernisation.gouv.fr/mois-innovation-publique/programme]]:
